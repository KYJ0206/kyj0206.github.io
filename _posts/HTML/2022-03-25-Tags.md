...
```html
" <button input type = "유형" id="id값"  [ 속성="속성 값" ] > " 
```
...
```html
< input type="image" src="https://images.velog.io/images/kyj0206/post/947a3102-cc60-45d1-b197-b28518b30a29/football-g26aef2ee8_640.png" >
이미지만 표시됨.
```
...
```html
< button type="submit><img src="https://images.velog.io/images/kyj0206/post/947a3102-cc60-45d1-b197-b28518b30a29/football-g26aef2ee8_640.png" >< /button >
이미지 주위에 사각형 테두리와 배경색이 지정됨. button 태그 자체 패딩도 추가됨.
```
...
특정 소스를 브라우저에 실행시켜 보이고 싶지 않을 때 사용.
